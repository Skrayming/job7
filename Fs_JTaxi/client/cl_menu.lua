...
local open = false 
local mainMenu8 = RageUI.CreateMenu('', 'Taxi')
	...
	if open then 
		...
		while open do 
		   RageUI.IsVisible(mainMenu8,function() 
			...
			RageUI.Separator("~y~↓ Options ↓				 ")
			RageUI.Button("Extras Taxi", nil , {RightLabel = "→"}, true , {
				onSelected = function()
			...
			--  RageUI.Button("Taxi Disponible", nil, {RightLabel = "→"}, true , {
			-- 	onSelected = function()
			-- 		codesCooldown1 = true
	...
	ESX.UI.Menu.Open(
	  ...
	  function(data, menu)
		...
		if player ~= -1 and distance <= 3.0 then
		  ...
		  menu.close()
		  if amount == nil then
			  exports['okokNotify']:Alert("Taxi", "Problèmes : Montant invalide", 5000, 'error')
		  else
			...
			Citizen.Wait(5000)
			  ...
			  Citizen.Wait(100)
			  exports['okokNotify']:Alert("Taxi", "Vous avez bien envoyer la facture", 5000, 'success')
		  end
  
		else
		  exports['okokNotify']:Alert("Taxi", "Problèmes : Aucun joueur à proximitée", 5000, 'error')
		end
...
local possible_mission = {
	...
	vector3(1875.6572265625, 3686.1088867188, 33.499801635742),
	vector3(305.43408203125, 2823.5502929688, 43.445690155029),
	vector3(469.2776184082, 2615.5375976563, 43.132236480713),
	vector3(2458.47265625, 4550.3271484375, 35.770442962646),
	vector3(96.464599609375, -833.88562011719, 31.567449569702),
	vector3(4528.7705078125, -4528.6220703125, 4.1392025947571),
	vector3(1437.0462646484, -2606.4418945313, 48.182918548584),
	vector3(1380.8078613281, -756.71246337891, 67.190223693848),
	vector3(-1737.6700439453, -724.65960693359, 10.439616203308),
	vector3(101.92938995361, -1955.4610595703, 20.750190734863),
